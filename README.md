...
## Projeto da aula e desafio
* Algumas configurações e funcionalidades legais são:
    1. Index da aula - index-aula.html e app-aula.ts, com console.log de funcionalidade.
    2. Index do desafio - index-desafio.html e app-desafio.ts.
